const worksData = [
  {
    id: 0,
    image: "./screen_img/nextProject.webp",
    title: "스타트업 프로젝트",
    badge: ["Next.js", "Typescript", "CSS Module", "Vercel"],
    desc: [
      "외주를 받아 진행했던 스타트업 홈페이지입니다.",
      "비밀 유지 서약으로 이미지와 텍스트는 임의로 대체했습니다.",
      "Vercel을 사용하여 호스팅했습니다.",
    ],
    url: "https://nextjs-project-pearl-mu.vercel.app/",
    git: "https://github.com/IPYURA/nextjs-project",
    modalInfo: {
      img: "./screen_img/nextProject.webp",
      additionalImg: [],
      period: "24.03 - (마무리 단계에 있습니다.)",
      features: [
        "Portal을 사용하여 Nav의 Contact(Form), Donate 모달 구현",
        "슬라이드 스크롤",
        "App 라우팅 방식",
      ],
      desc: [
        "[모달창이 열려있을 때 모달 바깥의 스크롤이 가능했던 현상]",
        "React Portal을 사용하여 렌더링 결과를 다른 DOM 노드로 이동시키는 방식으로 문제를 해결했습니다.",
        "",
        "[radio 타입의 input 태그 커스텀하기]",
        "Form 안에 포함된 radio가 UI적으로 좋지 않다고 판단하여 커스텀하는 방법을 찾아보았습니다.",
        "input을 안보이게 감추고 label 태그를 만들어 커스텀하는 방식으로 radio버튼을 커스텀했습니다.",
      ],
    },
  },
  {
    id: 1,
    image: "./screen_img/customer.webp",
    title: "고객 관리 시스템",
    badge: [
      "React",
      "Node.js",
    ...
    desc: [
      "AWS의 RDS를 사용한 MySQL Database 구축",
      "Node.js에서 RESTful API를 사용하여 고객 정보 추가",
      "카페24의 Linux 서버를 사용하여 Nginx로 웹 서버 구축 중에 있습니다.",
    ],
    url: "",
    git: "https://github.com/IPYURA/nodeJS-project",
    modalInfo: {
      img: "./screen_img/customer.webp",
      additionalImg: [],
      period: "24.03.20 - (현재 서버 구축 중)",
      features: [
        "Form 모달을 통해 고객 정보 추가",
        "Form을 통해 프로필 이미지 업로드",
        "삭제 버튼을 통해 고객 정보 삭제",
      ],
      desc: [
        "[방화벽 설정 문제]",
        "가상 서버의 방화벽 설정 중 잠시 자리를 비워야 하는 상황이 있었습니다.",
        "SSH 프로토콜 접속을 위해 22번 포트에 대한 접근 허용을 하기 전, 자리를 비운 사이 서버가 닫혀버려 SSH 접속이 불가능하게 되었습니다.",
        "결국 다시 OS를 설치하여 vi를 통해 이전 접속한 IP에 대한 정보를 삭제하고 접속에 성공했습니다.",
        "",
        "[업로드된 이미지가 불러와지지 않는 문제]",
        "이미지의 확장자를 같이 저장하지 않아 생기는 문제라는 것을 깨달았습니다.",
        "split과 pop메서드를 사용하여 filename을 받아올 때 확장자를 따로 분리한 뒤, 새로운 파일명 생성 시 합치는 방식으로 해결했습니다.",
      ],
    },
  },
  {
  ...
  {
    id: 3,
    image: "./screen_img/wordle.png",
    title: "웹 게임 Wordle!",
    badge: ["Javascript", "SCSS"],
    desc: [
      "단어맞추기 웹 게임",
      "정확한 위치와 철자일 경우 초록색 표시",
      "정답에 포함된 철자일 경우 노란색 표시",
      "정답에 포함된 철자가 아닌 경우 회색 표시",
    ],
    url: "https://wordle-cdg.web.app/",
    git: "https://github.com/IPYURA/Wordle",
    modalInfo: {
      img: "./modal_img/wordlegame.png",
      additionalImg: [],
      period: "24.03.04 (하루)",
      features: [
        "페이지가 로드될 때, 정답 랜덤 생성",
        "5글자를 넣어 정답 맞추기 (5번 기회)",
        "정답에 포함된 철자일 경우, 노란색 표시",
        "정답에 포함되고, 정확한 위치일 경우 초록색 표시",
        "게임이 종료되면 모달 페이지 생성",
      ],
      desc: [
        "[input태그의 입력 가능한 값을 영어 소문자로 제한하기]",
        "스마트폰의 경우, 영어 첫 글자를 대문자로 자동입력하는 경우가 많았습니다.",
        "toLowerCase() 메서드를 사용하여 자동으로 소문자로 바꾸어 주어 해결했습니다.",
        ...
        "",
        "[새로운 노드가 생성될 때 input값이 보존되지 않는 문제]",
  ...
  },
  {
    ...
    title: "내가 짱구 속 인물이라면?",
    badge: ["React", "Typescript", "JSON", "Styled-Components"],
    desc: [
  ...
  },
  {
    ...
    desc: [
      ...
      "무한 + 자동 슬라이더, 페이저 구현",
      "깔끔한 JS코드를 작성하려 고민하고 노력한 프로젝트입니다.",
      "반응형 구현",
    ],
  ...
  },
  {
    ...
    desc: ["현재 보고계신 페이지입니다."],
    url: "https://cdg-portfolio.web.app/",
    git: "https://github.com/IPYURA/CDG_Portfolio",
    modalInfo: {
  ...
  {
    id: 10,
    image: "./screen_img/movie.png",
    title: "Movie API 프로젝트",
    badge: ["React", "Typescript", "API", "Framer", "Styled-Components"],
    desc: ["현재 작업 중에 있습니다!!"],
    url: "https://movie-cdg.web.app/",
    git: "https://github.com/IPYURA/Movie",
    modalInfo: {
      img: "",
      additionalImg: [],
      period: "작업 중",
      features: [
        "API를 통한 영화 순위정보 가져오기",
        "모달창을 통한 상세 정보 페이지",
      ],
      desc: [""],
    },
